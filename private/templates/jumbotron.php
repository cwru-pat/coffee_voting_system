            ...
            ?>
                <div class="list-group-item voted paper-listing">
                    ...
                    <div class="btn-group voted paper" role="group">
                        ...
                        ?>
                        <a role="button" href="#" class="btn btn-default btn-xs voted-btn abstract-showhide" data-paperid="<?php print $paper["id"]; ?>" id="article-<?php print $paper["id"]; ?>-button" title="Toggle Abstract" data-toggle="button" data-toggle-tip="tooltip" data-container="body" data-placement="bottom">
                            Abstract
                        </a>
                        <?php
                        $isCreator = $user->isLoggedIn() && $user->id() == $paper["authors"];
                    ...
                    <span class="user-voters">
                        <?php
                        foreach ($paper_votes[$paper["id"]] as $user_id => $votes_data) {
                        ?>
                            <span class='user-sup <?php print ($votes_data["date"]<$paper_meeting_times["prev"]) ? "old-vote" : "";
                                print ($user_id=="bump")?"text-warning":""; ?>'>
                                <?php print $user_id;?>
                                <sup>
                                    <?php
                    ...
                    <div class="voted-paper-abstract" style="display: none;" id="article-<?php print $paper["id"]; ?>-abstract">
                        ...
                        <div class="article-button-holder voted" data-paperid="<?php print $paper["id"]; ?>">
                            ...
                            ?>
                                <span class='article-messages' id='article-voted-<?php print $paper["id"]; ?>-messages'>
                                    &nbsp;
                                </span>
                            <?php
                            }
