...
<h4>
  <?php if($user->isAdmin()||($user->isLoggedIn() && $user->id()==$paper["authors"])) {?>
    <a role="button" href="<?php print path()?>add?post-id=<?php print $paper['id']?>" class="pull-right btn btn-info btn-xs" data-toggle="tooltip" data-placement="bottom" title="Edit">
