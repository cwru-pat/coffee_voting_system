...
function format_arxiv_title_voted($title)
{
    ...
    if(count($article_data) == 6) {
        ...
        $pdf_link = '<a href="http://arxiv.org/pdf/'.$article.'.pdf" class="pdf-link btn btn-default btn-xs voted-btn pdf" role="button" title="Open PDF">PDF</a>';
        $arx_link = '<a href="http://arxiv.org/abs/'.$article.'" class="btn btn-default btn-xs voted-btn arxiv" role="button" title="Go to arXiv">arXiv</a>';
