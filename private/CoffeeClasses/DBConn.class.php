...
class DBConn
{
    ...
    public function boundCommand($statement, $params /* array of references; first entry is type string */)
    {
    ...
    public function boundQuery($statement, $params /* array of references */, $return_statement = false)
    {
